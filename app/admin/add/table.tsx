            ...
            <div className="card" style={{ margin: 0, borderRadius: 0 }}>
              <div className="card-body p-4">
                <div className="d-flex justify-content-between align-items-center mb-4">
                  ...
                  <button className="btn btn-primary btn-icon-text" onClick={() => { resetForm(); setIsModalOpen(true); }}>
                  ...
                  <table className="table table-striped">
                    ...
                    <tbody>
                      {isLoading ? (
                        ...
                        users.map(user => (
                          <tr key={user.id}>
                            <td><img src={user.avatar} alt={user.username} className="img-sm rounded-circle" /></td>
                            <td>{user.username}</td>
                            <td>{user.email}</td>
                            <td>
                            ...
                            <td>
                              <button className="btn btn-outline-primary btn-sm mr-2" onClick={() => handleEditUser(user)}>

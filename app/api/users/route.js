...
export async function POST(request) {
  try {
    ...
    try {
      ...
      console.error(
        "Erreur lors de la vérification de la structure de la table:",
        err,
      );
    }
    ...
    console.log(
      "Vérification de l'existence de l'utilisateur avec email:",
      email,
    );
    ...
    console.log(
      "Résultat de la recherche d'utilisateur existant:",
      existingUser,
    );
